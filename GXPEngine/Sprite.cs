...
namespace GXPEngine
{
    ...
    public class Sprite : GameObject
    {
        ...
        public float testa
        {
            ...
            set
            {
                r = Mathf.Clamp(value, 0, 1);

                byte rr = (byte)Math.Floor((r * 255));
                byte rg = (byte)Math.Floor((r * 255));
                byte rb = (byte)Math.Floor((r * 255));
        ...
        public Sprite(int spritewidth, int spriteheight, System.Drawing.Color color)
        {
            System.Drawing.Bitmap bitmap = new System.Drawing.Bitmap(spritewidth, spriteheight);
            ...
            gfx.FillRectangle(brush, 0, 0, spritewidth, spriteheight);
            initializeFromTexture(new Texture2D(bitmap));
        }
        //------------------------------------------------------------------------------------------------------------------------
        //														OnDestroy()
        ...
        public void test()
        {
            _bounds = new Rectangle(0, 0, 32, 32);
